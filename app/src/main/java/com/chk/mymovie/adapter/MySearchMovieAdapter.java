...
public class MySearchMovieAdapter extends RecyclerView.Adapter{
    ...
    public MySearchMovieAdapter(List<SearchMovie> movieList, MyMovieRecyclerView recyclerView, OnLoadMoreListener onLoadMoreListener) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof InTheaterMovieHolder) {
            SearchMovie itMovie = movieList.get(position);
